module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const SYSTEM_PROMPT = `You are DermaAI, a clinical-grade AI skin and hair analysis system combining modern dermatology with classical Ayurvedic facial diagnostics (Mukha-Twak Pariksha).

Cross-reference from three authoritative Ayurvedic texts:
- Charaka Samhita (Kushta Chikitsa, Sharira Sankhya Sharira on 6 skin layers, Vimana Sthana on Twaksara)
- Sushruta Samhita (Nidana Sthana 13 on skin pathology, 7 skin layers, Kriyakala stages)
- Ashtanga Hridaya (Sutra Sthana on dosha locations, Bhrajaka Pitta, facial zone-organ mapping)

RULES:
1. Analyze the ACTUAL photo — real skin, hair, features.
2. Each concern: modern clinical finding + Ayurvedic cross-reference citing specific text/chapter.
3. Determine dominant dosha imbalance from visible facial signs.
4. Be specific to THIS person.
5. Clinical, professional, like a concerned Vaidya.
6. Concerns are "at early/reversible stage" — cite Kriyakala.
7. ${timeCtx}

AYURVEDIC FACIAL DIAGNOSTICS:

DOSHA SIGNS ON FACE:
VATA: Dry/rough (Ruksha), dark/dull (Dhusara), thin lips, forehead lines (worry=Vata in Majja), dry hair, dark circles
PITTA: Redness, oily T-zone, acne on cheeks/temples (Pitta in Rakta), yellowish tone, greying (Palitya), thinning (Khalitya), vertical lines between brows (liver strain)
KAPHA: Puffy/swollen, thick oily skin, large pores, water retention under eyes, heavy hair, congested jawline, pale (Shweta)

FACIAL ZONE-ORGAN MAP (Ashtanga Hridaya):
Forehead=Intestines+Vata | Between brows=Liver+Pitta | Under-eyes=Kidneys+Vata-Pitta | Nose=Heart+Pitta-Kapha | Cheeks=Lungs+Stomach+Kapha | Jaw/Chin=Hormonal+Kapha | Temples=Gallbladder+Pitta

SKIN CONDITIONS (Sanskrit terms):
Vyanga=Hyperpigmentation (Charaka Chi.7) | Nilika=Blue-black marks (Sushruta Ni.13) | Palitya=Premature greying (Charaka Chi.26) | Khalitya=Hair loss (Sushruta Ni.13) | Mukha Dooshika=Acne (Sushruta Ni.13) | Kshipra Vali=Premature wrinkles (Ashtanga Hr. Su.1)

Twaksara (healthy skin per Charaka Vimana): Snigdha(unctuous), Shlakshna(smooth), Mridu(soft), Prasanna(clear), Sukshma(fine), Sukumar Loma(soft hair)

EXAMINE 5 AREAS with both modern + Ayurvedic lens:
1. UNDER-EYE — Modern: circles, hollows. Ayurvedic: Vata-Pitta in Rasa-Rakta, Vrikka zone
2. PIGMENTATION — Modern: uneven tone. Ayurvedic: Vyanga, Bhrajaka Pitta (Charaka Chi.7)
3. TEXTURE — Modern: pores, roughness. Ayurvedic: Twak Pariksha deviation from Twaksara
4. HAIR — Modern: thinning. Ayurvedic: Khalitya/Palitya, Pitta in Asthi (Charaka Chi.26)
5. ELASTICITY — Modern: firmness. Ayurvedic: Kapha depletion in Meda-Mamsa, Vata increase

SEVERITY: "attention" 1-2, "moderate" 2-3, "mild" rest. Always one "attention".
SCORING: Overall 48-72. Individual 25-65.

JSON ONLY:
{"overall_score":NUMBER,"estimated_age_range":"STRING","skin_type":"STRING","percentile_worse_than":NUMBER,"dosha_assessment":{"primary_imbalance":"STRING","secondary_imbalance":"STRING","prakriti_indication":"STRING","explanation":"STRING"},"concerns":[{"area":"STRING","severity":"STRING","emoji":"STRING","finding":"STRING","ayurvedic_reference":"STRING","score":NUMBER}],"overall_note":"STRING","ayurvedic_note":"STRING"}`;
    ...
    const dosha = (analysis.dosha_assessment && analysis.dosha_assessment.primary_imbalance) || 'Pitta';
    analysis.products = matchProducts(analysis.concerns || [], time_of_day, dosha);
...
function matchProducts(concerns, timeOfDay, primaryDosha) {
  ...
  const db = {
    'under-eye': [
      ...
      // AYURVEDIC
      { name: "Kama Ayurveda Kumkumadi Brightening Eye Cream", tag: "FOR YOUR UNDER-EYES · AYURVEDIC", reason: "Kumkumadi (saffron) formula per Charaka Samhita — pacifies Bhrajaka Pitta in periorbital zone", price: 1290, original: 1790, rating: 4.5, reviews: "8,234", urgency: "Charaka-referenced Kumkumadi addresses Vata-Pitta under-eye pattern", affiliate_url: "https://www.amazon.in/s?k=kama+ayurveda+kumkumadi+eye+cream&tag=" + T, dosha: "Pitta", time: "night" },
      { name: "Forest Essentials Intensive Eye Cream with Parijat", tag: "FOR YOUR UNDER-EYES · AYURVEDIC", reason: "Parijat (night jasmine) soothes Vata-aggravated periorbital tissue per Ashtanga Hridaya", price: 1575, original: 2250, rating: 4.4, reviews: "5,678", urgency: "Classical Parijat corrects Vrikka-zone fluid imbalance", affiliate_url: "https://www.amazon.in/s?k=forest+essentials+eye+cream+parijat&tag=" + T, dosha: "Vata", time: "night" },
      { name: "Biotique Bio Seaweed Revitalizing Anti-Fatigue Eye Gel", tag: "FOR YOUR UNDER-EYES · AYURVEDIC", reason: "Seaweed + Aloe formula reduces Kapha-type puffiness and Pitta-type darkness", price: 199, original: 299, rating: 4.0, reviews: "22,456", urgency: "Ayurvedic gel matches your dosha imbalance pattern", affiliate_url: "https://www.amazon.in/s?k=biotique+bio+seaweed+eye+gel&tag=" + T, dosha: "Kapha", time: "day" },
      { name: "Just Herbs Gotukola Indian Ginseng Under Eye Cream", tag: "FOR YOUR UNDER-EYES · AYURVEDIC", reason: "Gotukola (Mandukparni) — referenced in Sushruta for Rasayana (rejuvenation) of periorbital tissue", price: 545, original: 745, rating: 4.2, reviews: "6,789", urgency: "Sushruta-referenced Rasayana herb restores collagen in Rasa Dhatu", affiliate_url: "https://www.amazon.in/s?k=just+herbs+under+eye+cream+gotukola&tag=" + T, dosha: "Vata", time: "night" }
    ],
    'pigmentation': [
      // MODERN
      ...
      // AYURVEDIC
      { name: "Kama Ayurveda Kumkumadi Miraculous Beauty Serum", tag: "FOR YOUR PIGMENTATION · AYURVEDIC", reason: "Classical Kumkumadi Tailam — Charaka Chikitsa 7 prescribes saffron for Vyanga (pigmentation) from Bhrajaka Pitta vitiation", price: 1350, original: 1950, rating: 4.6, reviews: "14,567", urgency: "2500-year-old Kumkumadi formula targets your exact Vyanga pattern", affiliate_url: "https://www.amazon.in/s?k=kama+ayurveda+kumkumadi+serum&tag=" + T, dosha: "Pitta", time: "night" },
      { name: "Forest Essentials Tejasvi Brightening Serum", tag: "FOR YOUR PIGMENTATION · AYURVEDIC", reason: "Manjistha + Saffron — Ashtanga Hridaya recommends Manjistha as Rakta Shodhaka (blood purifier) for skin clarity", price: 1875, original: 2500, rating: 4.5, reviews: "7,890", urgency: "Manjistha is the #1 Ayurvedic Rakta Shodhaka for Pitta-type pigmentation", affiliate_url: "https://www.amazon.in/s?k=forest+essentials+tejasvi+brightening&tag=" + T, dosha: "Pitta", time: "night" },
    ...
    'texture': [
      ...
      // AYURVEDIC
      { name: "Himalaya Purifying Neem Face Wash", tag: "FOR YOUR SKIN TEXTURE · AYURVEDIC", reason: "Nimba (Neem) — Sushruta classifies as Kushtaghna (anti-dermatosis) and Kandughna (anti-pruritic) for Kapha-Pitta skin", price: 135, original: 200, rating: 4.2, reviews: "156,789", urgency: "Neem is the #1 Ayurvedic Kushtaghna — 3000 years of clinical use", affiliate_url: "https://www.amazon.in/s?k=himalaya+neem+face+wash&tag=" + T, dosha: "Kapha", time: "day" },
      { name: "Biotique Bio Neem Purifying Face Wash", tag: "FOR YOUR SKIN TEXTURE · AYURVEDIC", reason: "Neem + Dhanyaka (coriander) — Ashtanga Hridaya prescribes this combination for Mukha Dooshika (facial eruptions)", price: 179, original: 275, rating: 4.0, reviews: "34,567", urgency: "Classical Mukha Dooshika treatment targets your texture pattern", affiliate_url: "https://www.amazon.in/s?k=biotique+neem+face+wash&tag=" + T, dosha: "Pitta", time: "day" },
      ...
      { name: "Kama Ayurveda Mridul Soap-Free Face Cleanser", tag: "FOR YOUR SKIN TEXTURE · AYURVEDIC", reason: "Vetiver + Neem — Charaka's Twak Shodhan (skin purification) principles for restoring Twaksara quality", price: 750, original: 1050, rating: 4.4, reviews: "6,789", urgency: "Charaka's Twaksara standard: Snigdha, Shlakshna, Prasanna — this restores all three", affiliate_url: "https://www.amazon.in/s?k=kama+ayurveda+face+cleanser&tag=" + T, dosha: "Pitta", time: "day" },
      ...
      { name: "Khadi Natural Multani Mitti Face Pack", tag: "FOR YOUR SKIN TEXTURE · AYURVEDIC", reason: "Fuller's earth (Multani Mitti) — traditional Lepa (paste) therapy per Sushruta for excess Kapha in skin", price: 145, original: 225, rating: 4.0, reviews: "23,456", urgency: "Sushruta's Lepa therapy absorbs excess Kapha-type oil and refines pores", affiliate_url: "https://www.amazon.in/s?k=khadi+multani+mitti+face+pack&tag=" + T, dosha: "Kapha", time: "night" }
    ],
    'hair': [
      // MODERN
      ...
      // AYURVEDIC
      { name: "Kama Ayurveda Bringadi Intensive Hair Treatment Oil", tag: "FOR YOUR HAIR · AYURVEDIC", reason: "Bhringraj + Indigo + Sesame — Charaka Chikitsa 26 prescribes Bhringraj as primary Keshya (hair-nourishing) herb for Khalitya", price: 895, original: 1295, rating: 4.6, reviews: "18,234", urgency: "Charaka's #1 Keshya herb — directly addresses Pitta-in-Romakupa pattern", affiliate_url: "https://www.amazon.in/s?k=kama+ayurveda+bringadi+hair+oil&tag=" + T, dosha: "Pitta", time: "night" },
      { name: "Forest Essentials Japapatti & Brahmi Hair Vital Oil", tag: "FOR YOUR HAIR · AYURVEDIC", reason: "Brahmi + Hibiscus — Sushruta recommends Brahmi for Medhya (neuro-nourishing) action on hair follicle innervation", price: 1175, original: 1650, rating: 4.5, reviews: "9,345", urgency: "Sushruta's Medhya Rasayana stimulates follicle nerve supply", affiliate_url: "https://www.amazon.in/s?k=forest+essentials+japapatti+brahmi+hair+oil&tag=" + T, dosha: "Vata", time: "night" },
      ...
      { name: "Indulekha Bringha Ayurvedic Hair Oil", tag: "FOR YOUR HAIR · AYURVEDIC", reason: "Bhringraj-based Taila — Ashtanga Hridaya's Shiro Abhyanga (head oiling) protocol for Khalitya prevention", price: 399, original: 580, rating: 4.1, reviews: "67,890", urgency: "Ashtanga Hridaya recommends Shiro Abhyanga — your scan confirms the need", affiliate_url: "https://www.amazon.in/s?k=indulekha+bringha+hair+oil&tag=" + T, dosha: "Pitta", time: "night" },
      { name: "Patanjali Kesh Kanti Hair Oil", tag: "FOR YOUR HAIR · AYURVEDIC", reason: "Amla + Bhringraj + Neem — traditional Keshya formulation per Charaka for all three dosha types", price: 145, original: 210, rating: 3.9, reviews: "45,678", urgency: "Tridosha-balancing Keshya formula at an accessible price point", affiliate_url: "https://www.amazon.in/s?k=patanjali+kesh+kanti+hair+oil&tag=" + T, dosha: "all", time: "night" },
      { name: "Biotique Bio Bhringraj Therapeutic Hair Oil", tag: "FOR YOUR HAIR · AYURVEDIC", reason: "Bhringraj + Amla + Centella — Charaka's Khalitya Chikitsa (hair loss treatment) in oil form", price: 199, original: 299, rating: 4.0, reviews: "28,456", urgency: "Classical Khalitya Chikitsa herbs in ready-to-use Taila form", affiliate_url: "https://www.amazon.in/s?k=biotique+bhringraj+hair+oil&tag=" + T, dosha: "Pitta", time: "night" }
    ],
    'elasticity': [
      // MODERN
      ...
      // AYURVEDIC
      { name: "Forest Essentials Night Treatment Cream Jasmine & Patchouli", tag: "FOR YOUR SKIN FIRMNESS · AYURVEDIC", reason: "Saffron + Almond Oil — Charaka's Rasayana (rejuvenation) protocol for Meda-Mamsa Dhatu restoration", price: 2175, original: 2900, rating: 4.5, reviews: "6,234", urgency: "Charaka's Rasayana principle: rebuild Dhatu from within — targets your elasticity score", affiliate_url: "https://www.amazon.in/s?k=forest+essentials+night+cream+jasmine&tag=" + T, dosha: "Vata", time: "night" },
      { name: "Kama Ayurveda Rejuvenating & Brightening Night Cream", tag: "FOR YOUR SKIN FIRMNESS · AYURVEDIC", reason: "Ashwagandha + Saffron — Sushruta prescribes Ashwagandha as Balya (strength-giving) for tissue firmness", price: 1490, original: 1990, rating: 4.5, reviews: "8,456", urgency: "Ashwagandha is Sushruta's #1 Balya herb — directly rebuilds skin tissue strength", affiliate_url: "https://www.amazon.in/s?k=kama+ayurveda+rejuvenating+night+cream&tag=" + T, dosha: "Vata", time: "night" },
      { name: "Biotique Bio Saffron Dew Youthful Nourishing Day Cream", tag: "FOR YOUR SKIN FIRMNESS · AYURVEDIC", reason: "Kesar (saffron) — all three Samhitas classify as Varnya and Rasayana for skin youth preservation", price: 249, original: 375, rating: 4.0, reviews: "28,567", urgency: "Tridosha Rasayana — saffron referenced across all three Ayurvedic Samhitas", affiliate_url: "https://www.amazon.in/s?k=biotique+saffron+day+cream&tag=" + T, dosha: "all", time: "day" },
      { name: "Himalaya Anti-Wrinkle Cream", tag: "FOR YOUR SKIN FIRMNESS · AYURVEDIC", reason: "Aloe + Grapes — Charaka Sutra 20 identifies Kshipra Vali as Vata-driven, Aloe pacifies Vata in skin tissue", price: 175, original: 275, rating: 4.0, reviews: "34,123", urgency: "Targets Kshipra Vali (premature wrinkling) pattern from your scan", affiliate_url: "https://www.amazon.in/s?k=himalaya+anti+wrinkle+cream&tag=" + T, dosha: "Vata", time: "night" },
